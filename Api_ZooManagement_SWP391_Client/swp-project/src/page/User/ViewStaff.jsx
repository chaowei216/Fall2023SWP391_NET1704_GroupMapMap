...
function ViewStaff() {
  ...
  return (
    <div className="form-container">
      ...
      {staffProfile && staffProfile.length > 0 && staffProfile.map((item, index) => {
        return (
          <Form noValidate>
                ...
                <div className="row mb-3">
                  <div className="mb-3" style={{ width: "45%" }}>
                    ...
                    <Form.Control
                      ...
                      name="species"
                      value={
                        staffProfile[0].firstname + " " + staffProfile[0].lastname
                      }
                    />
                  </div>
                  <div className="mb-3" style={{ width: "45%" }}>
                    ...
                    >
                      {staffProfile[0].role === 2 && (
                        <Radio.Button
                          ...
                          value={2}
                        >
                          <span style={{ verticalAlign: "middle" }}>Staff</span>
                        </Radio.Button>
                      )}
                    ...
                    >
                      ...
                      {staffProfile[0].status === false && (
                        <Radio.Button
                          ...
                          value={false}
                        >
                          <span style={{ verticalAlign: "middle" }}>Out Job</span>
                        </Radio.Button>
                      )}
                    </Radio.Group>
                  </div>
