    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MealId = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AnimalId = table.Column<string>(type: "nvarchar(6)", nullable: false),
                    MealId = table.Column<string>(type: "nvarchar(6)", nullable: false),
                    StartEat = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndEat = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AnimalSpeciesSpeciesId = table.Column<string>(type: "nvarchar(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpeciesMeals", x => new { x.AnimalId, x.MealId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AnimalSpeciesSpeciesId,
                        principalTable: "AnimalSpecies",
                        principalColumn: "SpeciesId");
                    table.ForeignKey(
