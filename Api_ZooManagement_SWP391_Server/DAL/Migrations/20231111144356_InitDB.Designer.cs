...
namespace DAL.Migrations
{
    ...
    [Migration("20231111144356_InitDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.AnimalMeal", b =>
                {
                    b.Property<string>("AnimalId")
                        .HasColumnType("nvarchar(6)");
                    ...
                    b.Property<string>("AnimalSpeciesSpeciesId")
                        .HasColumnType("nvarchar(6)");

                    b.Property<DateTime>("EndEat")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("StartEat")
                        .HasColumnType("datetime2");

                    b.HasKey("AnimalId", "MealId");

                    b.HasIndex("AnimalSpeciesSpeciesId");

                    b.HasIndex("MealId");

                    b.ToTable("AnimalMeals");
                });
            ...
            modelBuilder.Entity("DAL.Entities.FoodMeal", b =>
                {
                    b.Property<string>("FoodId")
                        .HasColumnType("nvarchar(6)");
            ...
            modelBuilder.Entity("DAL.Entities.AnimalMeal", b =>
                {
                    b.HasOne("DAL.Entities.Animal", "Animal")
                        .WithMany("AnimalMeals")
                        .HasForeignKey("AnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Entities.AnimalSpecies", null)
                        .WithMany("SpeciesMeals")
                        .HasForeignKey("AnimalSpeciesSpeciesId");
